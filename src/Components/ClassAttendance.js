...
export default function ClassAttendance({ stud }) {
    ...
    const fetchInfo = async () => {
      ...
      try {
        const res = await fetch(
          "https://bf39nos9jf.execute-api.us-east-1.amazonaws.com/attendance-analytics",
          { signal: ac.signal }
        );
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <span className="text-[12px] text-gray-500">Class</span>
    </div>
  );
}
